...
type CategoriesService interface {
	...
	UpdateCategory(w http.ResponseWriter, r *http.Request) (CategoryResponse, int, []errors.ApiError)
	DeleteCategory(w http.ResponseWriter, r *http.Request) (int, []errors.ApiError)
}
